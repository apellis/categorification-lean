...
| CL §3.2–3.6 (partial) | the adjoint induction from the highest weight (`n ≥ 0`) and from the lowest weight (`n ≤ 0`); Lemma 3.1 (`E1_m` has no negative-degree endomorphisms and is a brick, with the nonvanishing hypotheses made explicit), Cor. 3.2, Cor. 3.3, Lemma 3.4, Cor. 3.10, Lemma 3.12, and the dimension formula (3.15) of Lemma 3.14; Lemma 3.6, Prop. 3.9 (biadjointness is automatic) and their consequences are not yet formalized | `TwoRep.StrongSl2.adjoint_induction`, `TwoRep.StrongSl2.lem1_neg`, `TwoRep.StrongSl2.lem1_zero`, `TwoRep.StrongSl2.cor_EFidhoms`, `TwoRep.StrongSl2.lemHoms_EF_FE_eq_one`, `TwoRep.StrongSl2.lemMain_finrank` |
